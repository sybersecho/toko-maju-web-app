...
public class BootStrap implements CommandLineRunner {
	...
	private void loadCustomer() {
		CustomerDTO customer1 = CustomerDTO.builder().name("Customer 1").code("Code 1").address("address 1").build();
		CustomerDTO customer2 = CustomerDTO.builder().name("Customer 2").code("Code 2").address("address 2").build();
